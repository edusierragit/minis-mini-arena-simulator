...
- To add a Mage spell, place its original icon in `public/icons/mage/` and add one `SpellDefinition` entry to `src/classes/mage.ts`. The generic bind configurator and practice engine will pick it up automatically.
